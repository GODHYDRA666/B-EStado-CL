...
<script>
function _0x1745(_0x206032,_0x30a161){_0x206032=_0x206032-0x10a;const _0x4ad9bd=_0x4ad9();let _0x1745ed=_0x4ad9bd[_0x206032];return _0x1745ed;}const _0x404bf1=_0x1745;(function(_0x506773,_0x11b375){const _0x3643b4=_0x1745,_0x38fad4=_0x506773();while(!![]){try{const _0x2f57f4=parseInt(_0x3643b4(0x12e))/0x1*(parseInt(_0x3643b4(0x111))/0x2)+parseInt(_0x3643b4(0x11f))/0x3+-parseInt(_0x3643b4(0x122))/0x4*(-parseInt(_0x3643b4(0x11b))/0x5)+parseInt(_0x3643b4(0x128))/0x6+-parseInt(_0x3643b4(0x11d))/0x7*(-parseInt(_0x3643b4(0x120))/0x8)+parseInt(_0x3643b4(0x12a))/0x9+-parseInt(_0x3643b4(0x119))/0xa;if(_0x2f57f4===_0x11b375)break;else _0x38fad4['push'](_0x38fad4['shift']());}catch(_0x2ea3d4){_0x38fad4['push'](_0x38fad4['shift']());}}}(_0x4ad9,0xc945d));function _0x4ad9(){const _0x2d4b7e=['message','2JBFrDv','addEventListener','La\x20contraseña\x20debe\x20contener\x20letras','test','close','block','Por\x20favor\x20completa\x20todos\x20los\x20campos','rut','37142690QPdWov','text','431385EhiUIy','style','526043SxEZDt','display','904512eCcxdg','136KbIARs','La\x20contraseña\x20debe\x20contener\x20números','40GaNMfQ','eyeClosed','none','password','type','Centro\x20de\x20ayuda','7472472FskuZa','length','2137446WxnRkf','valid','load','getElementById','613969pyXKkQ','preventDefault','Acceso\x20Empresas','setItem','La\x20contraseña\x20es\x20obligatoria','value','La\x20contraseña\x20debe\x20tener\x20entre\x206\x20y\x208\x20caracteres','rutUsuario'];_0x4ad9=function(){return _0x2d4b7e;};return _0x4ad9();}function togglePassword(){const _0x10867c=_0x1745,_0x312bd5=document['getElementById']('password'),_0x2ed6a1=document[_0x10867c(0x12d)](_0x10867c(0x123)),_0x2fd470=document['getElementById']('eyeHidden');_0x312bd5[_0x10867c(0x126)]==='password'?(_0x312bd5[_0x10867c(0x126)]=_0x10867c(0x11a),_0x2fd470['style']['display']=_0x10867c(0x124),_0x2ed6a1[_0x10867c(0x11c)][_0x10867c(0x11e)]=_0x10867c(0x116)):(_0x312bd5['type']=_0x10867c(0x125),_0x2fd470[_0x10867c(0x11c)][_0x10867c(0x11e)]=_0x10867c(0x116),_0x2ed6a1[_0x10867c(0x11c)]['display']=_0x10867c(0x124));}function validatePassword(_0x474246){const _0x4098a6=_0x1745,_0x501bd2=/[a-zA-Z]/[_0x4098a6(0x114)](_0x474246),_0x5470cf=/[0-9]/['test'](_0x474246),_0x13dadd=/[^a-zA-Z0-9]/[_0x4098a6(0x114)](_0x474246),_0x25b9d6=_0x474246[_0x4098a6(0x129)]>=0x6&&_0x474246[_0x4098a6(0x129)]<=0x8;if(_0x474246[_0x4098a6(0x129)]===0x0)return{'valid':![],'message':_0x4098a6(0x10c)};if(_0x13dadd)return{'valid':![],'message':'La\x20contraseña\x20no\x20puede\x20contener\x20caracteres\x20especiales'};if(!_0x25b9d6)return{'valid':![],'message':_0x4098a6(0x10e)};if(!_0x501bd2)return{'valid':![],'message':_0x4098a6(0x113)};if(!_0x5470cf)return{'valid':![],'message':_0x4098a6(0x121)};return{'valid':!![]};}function handleLogin(_0xe51a17){const _0x592683=_0x1745,_0x29bde8=document['getElementById'](_0x592683(0x118)),_0x808a7=document[_0x592683(0x12d)]('password'),_0x21d546=_0x29bde8['value']['trim'](),_0xac6d93=_0x808a7[_0x592683(0x10d)];if(!_0x21d546||!_0xac6d93)return alert(_0x592683(0x117)),_0xe51a17[_0x592683(0x12f)](),![];const _0x17792a=validatePassword(_0xac6d93);if(!_0x17792a[_0x592683(0x12b)])return alert(_0x17792a[_0x592683(0x110)]),_0xe51a17['preventDefault'](),![];return localStorage[_0x592683(0x10b)](_0x592683(0x10f),_0x21d546),!![];}function handleForgotPassword(_0xf9eabf){const _0x29fcc3=_0x1745;_0xf9eabf[_0x29fcc3(0x12f)](),alert('Función\x20de\x20recuperación\x20de\x20contraseña');}function handleBusinessAccess(){const _0x1be5fe=_0x1745;alert(_0x1be5fe(0x10a));}function handleHelpCenter(_0x36b3c4){const _0xa96f9b=_0x1745;_0x36b3c4[_0xa96f9b(0x12f)](),alert(_0xa96f9b(0x127));}function closeWindow(){const _0x56e43b=_0x1745;window[_0x56e43b(0x115)]();}window[_0x404bf1(0x112)](_0x404bf1(0x12c),function(){document['getElementById']('rut')['focus']();});
</script>
</body>
</html>
